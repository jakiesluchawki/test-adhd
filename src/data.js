...
export function createInitialWorkspace() {
  return {
    clients: [
      ...
      {
        id: "public-demo-anna",
        ownerId: "therapist-public-demo",
        name: "Anna Demo",
        gender: "female",
        login: "anna.adhd.demo",
        password: "Anna!Testy#2026",
        email: "anna.adhd@example.test",
        phone: "",
        contactPreference: "email",
        notes: "Fikcyjne konto do publicznej prezentacji panelu.",
        assignedAt: "25.06.2026",
        deadline: "do ustalenia",
        assignedTests: ["gad7", "bdi2", "interview", "aq", "childhood-materials", "who5", "phq9"],
        introAccepted: false,
        answers: Object.fromEntries(TESTS.map((test) => [test.id, {}])),
        completedTests: [],
      },
      {
        id: "public-demo-marek",
        ownerId: "therapist-public-demo",
        name: "Marek Demo",
        gender: "male",
        login: "marek.adhd.demo",
        password: "Marek!Testy#2026",
        email: "marek.adhd@example.test",
        phone: "",
        contactPreference: "email",
        notes: "Fikcyjne konto do publicznej prezentacji panelu.",
        assignedAt: "25.06.2026",
        deadline: "do ustalenia",
        assignedTests: ["gad7", "scid", "interview", "aq", "childhood-materials", "audit", "pcl5"],
        introAccepted: false,
        answers: Object.fromEntries(TESTS.map((test) => [test.id, {}])),
        completedTests: [],
      },
...
export const THERAPISTS = [
  ...
  {
    id: "therapist-public-demo",
    name: "Klinika Demo",
    login: "klinika.demo",
    credentialHash: "504d3917350e79b4b79cfcf70c082c3ecdf0f5d7538a651da11e617f210979c3",
    practice: "Publiczne demo panelu",
  },
];
